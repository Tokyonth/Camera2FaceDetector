...
object CameraUtils {
    ...
    fun calculationSize(map: StreamConfigurationMap, calculationSize: CalculationSize): Size {
        ...
        val aspectRatio = AspectRatio.of(1, 1)
        var preferred: Size
        ...
        if (calculationSize == CalculationSize.IMAGE) {
            return preferred
        }
    ...
    class AspectRatio constructor(private val x: Int, private val y: Int) : Comparable<AspectRatio>,
        ...
        companion object {
            ...
            @JvmField
            val CREATOR: Parcelable.Creator<AspectRatio> =
                object : Parcelable.Creator<AspectRatio> {
    ...
    class Size internal constructor(val width: Int, val height: Int) : Comparable<Size> {
        ...
        override fun compareTo(@NonNull other: Size): Int {
            val area = areaSize
            val anotherArea = other.areaSize
